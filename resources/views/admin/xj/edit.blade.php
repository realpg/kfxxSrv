                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="author" name="author" type="text" class="form-control"
                                           placeholder="请输入作者"
                                           value="{{ isset($data->author) ? $data->author : '北京大学第三医院' }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="margin-top-10 row">
                                        @foreach($xj_types as $xj_type)
                                            <div class="col-xs-4">
                                                <input type="checkbox" name="type[]" value="{{$xj_type->id}}"
                                                       class="minimal" {{ isset($xj_type->checked) ? 'checked':'' }}>
                                                <span
                                ...
                                <div>
                                    <div class="white-bg margin-b-10" style="background-color: white;">
                                        ...
                                        <span class="time"><i
                                            ...
                                            <a href="{{URL::asset('/admin/xj/delStep/')}}/{{$step->id}}"
