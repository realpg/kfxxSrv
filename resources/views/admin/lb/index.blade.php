                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($datas as $data)
                                <tr style="word-break:break-all;width: 17%"id="tr_{{$data->id}}">
                                    ...
                                    <td style="word-break:break-all;width: 17%"><span class="line-height-30">{{$data->created_at_str}}</span>
                                    </td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="desc" name="desc" type="text" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
