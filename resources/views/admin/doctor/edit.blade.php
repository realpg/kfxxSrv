...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <small>新建/编辑 医师/康复师/管理员（初始密码：Aa123456）</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li>
            <li class="active">医师/康复师/管理员</li>
                ...
                <div class="box box-info">
                    ...
                    <form action="" method="post" class="form-horizontal" onsubmit="return checkValid();">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group" style="margin-top: 15px;">
                                <label for="phonenum" class="col-sm-2 control-label">性别*</label>

                                <div class="col-sm-10">
                                    <select id="gender" name="gender" class="form-control">
                                        <option value="0" {{ $data->gender==='0' ? 'selected' : '' }}>保密</option>
                            ...
                            <div class="form-group" style="margin-top: 15px;">
                                ...
                                <div class="col-sm-10">
                                    <select id="duty" name="duty" class="form-control">
                                        <option value="普通医师" {{ $data->duty==='普通医师' ? 'selected' : '' }}>普通医师</option>
                                        <option value="专家医师" {{ $data->duty==='专家医师' ? 'selected' : '' }}>专家医师</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" style="margin-top: 15px;">
                                ...
                                <div class="col-sm-10">
                                    <select id="dep" name="dep" class="form-control">
                                        <option value="运动医学一科室" {{ $data->dep==='运动医学一科室' ? 'selected' : '' }}>运动医学一科室
                                        </option>
                                        <option value="运动医学二科室" {{ $data->dep==='运动医学二科室' ? 'selected' : '' }}>运动医学二科室
                                        </option>
                                        <option value="康复医学一科室" {{ $data->dep==='康复医学一科室' ? 'selected' : '' }}>康复医学一科室
                                        </option>
                                        <option value="康复医学二科室" {{ $data->dep==='康复医学二科室' ? 'selected' : '' }}>康复医学二科室
                                        </option>
                                    </select>
                                </div>
                            </div>
